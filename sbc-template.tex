...
O mapeamento sistemático da literatura realizado em \cite{Dondici2025Mapeamento}
concentra-se em jogos digitais educacionais voltados para o ensino de circuitos
lógicos, especificamente. A análise realizada pelos autores suporta a colocação
de que a maioria de tais jogos são voltados para o público de estudantes do
ensino superior, carecendo de direcionamento para a introdução do pensamento
computacional na educação básica, como é o objetivo primário deste trabalho. No
entanto, esta mesma análise também demonstra os jogos educacionais desse caráter
atraem o interesse da comunidade científica brasileira, o que coloca mais em
evidência a relevância de tais trabalhos no contexto da ciência brasileira e da
